  ...
  render() {
    ...
    return (
      ...
      {/* hedder */}
        ...
        {/* 左边控制 */}
          <Buttons actonPressOut={this.actonPressOut} actonPressIn={this.actonPressIn} btnForbidden={btnForbidden}  actIndex={actIndex}  steeringWheelBtn={steeringWheelBtn}></Buttons>
