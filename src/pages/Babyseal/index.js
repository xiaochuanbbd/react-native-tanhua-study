...
export default class module extends Component {
  ...
  render() {
    const { btnForbidden, actIndex, iconsBtn, steeringWheelBtn, openCamera } =
      this.state;
    return (
      <View style={{ flex: 1, justifyContent: "space-between" }}>
        ...
        <View style={styles.middleContainer}>
          {/* 左边控制 */}
          <Buttons
            actonPressOut={this.actonPressOut}
            actonPressIn={this.actonPressIn}
            btnForbidden={btnForbidden}
            actIndex={actIndex}
            steeringWheelBtn={steeringWheelBtn}
          ></Buttons>
          <Image
            style={{ alignItems: "center", width: 282, height: 162 }}
            source={require("./img/middle_m.png")}
          ></Image>
          {/* 右边的active */}
          <IconsBtn
            actBtnHandler={this.actBtnHandler}
            btnForbidden={btnForbidden}
            actIndex={actIndex}
            iconsBtn={iconsBtn}
          ></IconsBtn>
